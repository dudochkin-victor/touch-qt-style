...
class QtScroller : public QObject
{
    ...
    Q_PROPERTY(QtScrollerProperties scrollerProperties READ scrollerProperties WRITE setScrollerProperties)
    Q_ENUMS(State)
...
public Q_SLOTS:
    ...
    void ensureVisible(const QRectF &rect, qreal xmargin, qreal ymargin, int scrollTime = 1000);
